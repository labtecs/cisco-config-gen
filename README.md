...
Linux-Systeme (und Docker) unterscheiden hier streng, was zu Fehlern führen kann ("Module not found"), wenn die Schreibweise im Code (import ... from './App.jsx') nicht exakt mit dem Dateinamen übereinstimmt.
Lizenz
